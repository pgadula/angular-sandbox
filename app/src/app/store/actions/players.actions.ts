...
export const setUser1Success = createAction('[PLAYERS] Set User 1 Success', props<{user:Player}>());
...
export const setUser2Success = createAction('[PLAYERS] Set User 2 Success',  props<{user:Player}>());
